...
export aperture_gain, aperture_diameter, detection_range, fov_from_aspect, SEEKER_DETECT_MODES
export rcs_aspect, aspect_angle, TARGET_TURN_PLANES
...
export off_axis_ratio                       # slice 55 — the two-axis (fan-beam) window
